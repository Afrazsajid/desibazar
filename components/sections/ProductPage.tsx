...
const ProductFullCard: React.FC<ProductFullCardProps> = ({ product }) => {
  ...
  return (
    <div className="flex flex-col items-center bg-gray-100 py-8">
      {/* Product Section */}
      <div className="w-full max-w-screen-lg p-6 bg-white shadow-lg rounded-lg">
      ...
      <span className="text-sm text-gray-600 ml-2">({reviewCount} Reviews)</span>
            ...
            <div className="flex items-center mb-4">
              ...
              {isOutOfStock && (
                <span className="ml-4 px-3 py-1 bg-red-100 text-red-600 text-sm font-medium rounded-full">
                  Out of Stock
                </span>
              )}
            </div>
